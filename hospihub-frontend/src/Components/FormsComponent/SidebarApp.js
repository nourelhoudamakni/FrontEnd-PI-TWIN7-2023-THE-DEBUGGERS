...
function SidebarApp() {
    ...
    const addImageprofile = (e) => {
        ...
        axios.put(`http://localhost:5000/patient/addImageProfile/${doctor._id}`, formData)
          .then((response) => {
                        ...
                        {/*sidebar start*/}
                            ...
                            <div className="sidebar  ">
                                ...
                                <div className="profile_info">
                                    <img src={`http://127.0.0.1:8887/userProfile/${doctor.image}`} className="profile_image  " alt="" />
